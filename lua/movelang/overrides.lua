...
-- For some reason the endpoint textDocument/hover from move-analyzer returns
...
-- the program waits some input.  Take a look at move-analyzer/editors/code/src/toolchain.ts.
