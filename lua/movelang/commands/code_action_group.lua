...
---@class movelang.RACodeAction
---@field kind string
---@field group? string
---@field edit? table
---@field command? { command: string } | string

---@class movelang.RACommand
---@field title string
---@field group? string
---@field command string
---@field arguments? any[]

---@param action movelang.RACodeAction | movelang.RACommand
...
---@alias action_tuple { [1]: number, [2]: movelang.RACodeAction|movelang.RACommand }
...
function M.on_user_choice(action_tuple, ctx)
  ...
  if not action.edit and type(code_action_provider) == 'table' and code_action_provider.resolveProvider then
    client.request('codeAction/resolve', action, function(err, resolved_action)
      ---@cast resolved_action movelang.RACodeAction|movelang.RACommand
      if err then
...
---@class movelang.CodeActionWindowGeometry
---@field width integer

---@param action_tuples action_tuple[]
---@param is_group boolean
---@return movelang.CodeActionWindowGeometry
...
---@class movelang.RACodeActionResult
---@field result? movelang.RACodeAction[] | movelang.RACommand[]

---@param results { [number]: movelang.RACodeActionResult }
---@param ctx table
local function on_code_action_results(results, ctx)
  ...
  ---@class movelang.PartitionedActions
  M.state.actions = {
    grouped = {},
    ungrouped = {},
  }
...
---@class movelang.CodeActionWindowState
---@field bufnr integer | nil
---@field winnr integer | nil
---@field geometry movelang.CodeActionWindowGeometry | nil
---@field clear fun()

---@class movelang.CodeActionInternalState
M.state = {
  ctx = {},
  ---@type movelang.PartitionedActions
  actions = {
  ...
  ---@type movelang.CodeActionWindowState
  primary = {
    bufnr = nil,
    winnr = nil,
    geometry = nil,
...
M.code_action_group = function()
  local context = {}
  context.diagnostics = require('movelang.compat').get_line_diagnostics()
